...
function getAttributeType (attribute, sourceCode) {
  ...
  if (attribute.directive && !isBind) {
    ...
    if (name === 'is') {
      ...
      return ATTRS.UNIQUE
    } else if (name === 'class' && !attribute.directive) {
      return ATTRS.CLASSES
    } else if (name === 'href') {
      return ATTRS.HREFS
    } else if (name === 'type') {
      return ATTRS.TYPE, ATTRS.NAME
    } else if (name === 'name') {
      return ATTRS.NAME
    } else {
...
function create (context) {
  ...
  let attributeOrder = [ATTRS.DEFINITION, ATTRS.LIST_RENDERING, ATTRS.CONDITIONALS, ATTRS.RENDER_MODIFIERS, ATTRS.GLOBAL, ATTRS.UNIQUE, ATTRS.TWO_WAY_BINDING, ATTRS.OTHER_DIRECTIVES, ATTRS.OTHER_ATTR, ATTRS.EVENTS, ATTRS.CONTENT, ATTRS.CLASSES, ATTRS.HREFS, ATTRS.TYPE, ATTRS.NAME]
